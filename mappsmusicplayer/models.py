...
from mappsmusicplayer.grpc import mmp_pb2 as proto


class Protoble:
    """
    This class makes sure the extended class
    is able to represent as a protobuf object
    Which then can be used to transfer over
    a network
    """
