...
from mappsmusicplayer.grpc import mmp_pb2_grpc as rpc
from mappsmusicplayer.interfaces import Logger, EventFiring
...
class MediaDownloader(rpc.MediaDownloaderServicer, Logger, EventFiring):
    ...
    so it can be used in the music_server package
    """
    ...
    def __process_conf(self):
        self._raw_download_location = \
            self._config.get(self._section, 'download_location',
