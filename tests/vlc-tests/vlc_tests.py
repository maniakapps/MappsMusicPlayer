...
class VLCTests(unittest.TestCase):
    samplefile = r'C:\Users\MAPC\PycharmProject\MappsMusicPlayer2\tests\testfiles\music\Eminem - Lose Yourself [HD].mp3'
    ...
    def test_stream_mixcloud(self):
        url = 'https://stream6.mixcloud.com/secure/c/m4a/64/4/e/3/5/b074-a7ef-4da5-a2cf-a390da945cbb.m4a?sig=xlsqXNRipncHPvbxNMMnfQ'
