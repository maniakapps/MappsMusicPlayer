...
from mappsmusicplayer.datastructures import MusicQueue
from mappsmusicplayer.models import SongModel
from mappsmusicplayer.music_player import MusicPlayer
...
class MusicPlayerTests(unittest.TestCase):
    ...
    def playlist_test():
        ...
        song1 = SongModel('First Song', 'testfiles/music/krtheme.wav')
        ...
        print("previous song: " + str(queue.previous()))
        song2 = SongModel('Second Song', 'testfiles/music/krtheme-cut.mp3')
        ...
        print("previous song: " + str(queue.previous()))
        print("current song" + str(queue.current()))
        song3 = SongModel('Third Song', 'testfiles/music/Classic/dummy.wav')
